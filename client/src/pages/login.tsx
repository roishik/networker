  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Networker</h1>
        <p className="text-slate-600 text-lg">Smart contact management for founders</p>
      </div>
      ...
      <div className="w-full space-y-6">
        <button 
          ...
          disabled={loading}
          className="w-full bg-white border border-slate-300 rounded-lg px-6 py-4 flex items-center justify-center space-x-3 shadow-sm hover:shadow-md transition-shadow disabled:opacity-50"
        >
          {loading ? (
